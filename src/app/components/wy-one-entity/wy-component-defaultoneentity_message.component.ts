...
@Component({
    selector: 'wy-component-defaultoneentity_message',
    templateUrl: './wy-component-defaultoneentity_message.component.html',
    styleUrls: ['./wy-one-entity.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class WyOneEntityComponent_DefaultOneEntity_Message extends WyOneEntityBaseComponent implements OnInit {
    ...
    public createNewEditForm() {
        this.editForm = new FormGroup({
            ...
            'Id': new FormControl(),
                    ...
                    'MessageContents': new FormControl({value: '', disabled: JSON.parse('false')}
                    ),
        ...
        this.exp = new DynamicObjectExpressionApi(this.editForm, null, 'Message', null, this.usrSet); // TODO: support owner entity
    }
    ngOnInit() {
    ...
    protected getComponentIdentifier(): string {
        return 'wy-component-defaultoneentity_message';
    }
