...
@Component({
    selector: 'wy-component-defaultoneentity_action',
    templateUrl: './wy-component-defaultoneentity_action.component.html',
    styleUrls: ['./wy-one-entity.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class WyOneEntityComponent_DefaultOneEntity_Action extends WyOneEntityBaseComponent implements OnInit {
    ...
    public createNewEditForm() {
        this.editForm = new FormGroup({
            ...
            'Id': new FormControl(),
                    ...
                    'Contact': new FormControl({value: '', disabled: JSON.parse('false')}
                    ),
        ...
        this.exp = new DynamicObjectExpressionApi(this.editForm, null, 'Action', null, this.usrSet); // TODO: support owner entity
    }
    ngOnInit() {
    ...
    protected getComponentIdentifier(): string {
        return 'wy-component-defaultoneentity_action';
    }
